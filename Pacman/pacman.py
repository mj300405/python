...
blinky_img = pygame.transform.scale(pygame.image.load(f'images/blinky.png'), (45, 45))
pinky_img = pygame.transform.scale(pygame.image.load(f'images/pinky.png'), (45, 45))
inky_img = pygame.transform.scale(pygame.image.load(f'images/inky.png'), (45, 45))
clyde_img = pygame.transform.scale(pygame.image.load(f'images/clyde.png'), (45, 45))
spooked_img = pygame.transform.scale(pygame.image.load(f'images/spooked.png'), (45, 45))
...
class Ghost:
    ...
    def check_collisions(self):
        ...
        if 0 < self.center_x // 30 < 29:
            if level[(self.center_y - margin) // tile_height][self.center_x // tile_width] == 9:
                self.turns[2] = True
            if level[self.center_y // tile_height][(self.center_x - margin) // tile_width] < 3 \
                    or (level[self.center_y // tile_height][(self.center_x - margin) // tile_width] == 9 and (
            ...
            if level[self.center_y // tile_height][(self.center_x + margin) // tile_width] < 3 \
                    ...
                    self.in_box or self.dead)):
                self.turns[0] = True
            if level[(self.center_y + margin) // tile_height][self.center_x // tile_width] < 3 \
                    or (level[(self.center_y + margin) // tile_height][self.center_x // tile_width] == 9 and (
                    self.in_box or self.dead)):
                self.turns[3] = True
            if level[(self.center_y - margin) // tile_height][self.center_x // tile_width] < 3 \
                    or (level[(self.center_y - margin) // tile_height][self.center_x // tile_width] == 9 and (
            ...
            if self.direction == 2 or self.direction == 3:
                ...
                if 12 <= self.center_y % tile_height <= 18:
                    if level[self.center_y // tile_height][(self.center_x - tile_width) // tile_width] < 3 \
                            or (level[self.center_y // tile_height][(self.center_x - tile_width) // tile_width] == 9 and (
                            self.in_box or self.dead)):
                        self.turns[1] = True
                    if level[self.center_y // tile_height][(self.center_x + tile_width) // tile_width] < 3 \
                            or (level[self.center_y // tile_height][(self.center_x + tile_width) // tile_width] == 9 and (
...
def check_position(centerx, centery):
    ...
    if centerx // 30 < 29:
        if direction == 0:
            if level[centery // tile_height][(centerx - margin) // tile_width] < 3:
                turns[1] = True
        if direction == 1:
            if level[centery // tile_height][(centerx + margin) // tile_width] < 3:
                turns[0] = True
        if direction == 2:
            if level[(centery + margin) // tile_height][centerx // tile_width] < 3:
                turns[3] = True
        if direction == 3:
            if level[(centery - margin) // tile_height][centerx // tile_width] < 3:
                turns[2] = True
